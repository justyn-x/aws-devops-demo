...
const file_todo_v1_todo_proto_rawDesc = "" +
	"\n" +
	"\x12todo/v1/todo.proto\x12\atodo.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\"\xe2\x01\n" +
	"\x04Todo\x12\x0e\n" +
	...
	"\x04todo\x18\x01 \x01(\v2\r.todo.v1.TodoR\x04todo\"N\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id2\xd8\x03\n" +
	"\vTodoService\x12[\n" +
	"\n" +
	...
	"\tListTodos\x12\x19.todo.v1.ListTodosRequest\x1a\x1a.todo.v1.ListTodosResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/todos\x12e\n" +
	"\n" +
	"UpdateTodo\x12\x1a.todo.v1.UpdateTodoRequest\x1a\x1b.todo.v1.UpdateTodoResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*2\x13/v1/todos/{todo.id}\x12X\n" +
	"\n" +
	"DeleteTodo\x12\x1a.todo.v1.DeleteTodoRequest\x1a\x16.google.protobuf.Empty\"\x16\x82\xd3\xe4\x93\x02\x10*\x0e/v1/todos/{id}B\x89\x01\n" +
	"\vcom.todo.v1B\tTodoProtoP\x01Z2github.com/example/todo-service/gen/todo/v1;todov1\xa2\x02\x03TXX\xaa\x02\aTodo.V1\xca\x02\aTodo\\V1\xe2\x02\x13Todo\\V1\\GPBMetadata\xea\x02\bTodo::V1b\x06proto3"
...
var file_todo_v1_todo_proto_depIdxs = []int32{
	...
	0,  // 5: todo.v1.UpdateTodoRequest.todo:type_name -> todo.v1.Todo
	11, // 6: todo.v1.UpdateTodoRequest.update_mask:type_name -> google.protobuf.FieldMask
	0,  // 7: todo.v1.UpdateTodoResponse.todo:type_name -> todo.v1.Todo
	1,  // 8: todo.v1.TodoService.CreateTodo:input_type -> todo.v1.CreateTodoRequest
	3,  // 9: todo.v1.TodoService.GetTodo:input_type -> todo.v1.GetTodoRequest
	5,  // 10: todo.v1.TodoService.ListTodos:input_type -> todo.v1.ListTodosRequest
	7,  // 11: todo.v1.TodoService.UpdateTodo:input_type -> todo.v1.UpdateTodoRequest
	9,  // 12: todo.v1.TodoService.DeleteTodo:input_type -> todo.v1.DeleteTodoRequest
	2,  // 13: todo.v1.TodoService.CreateTodo:output_type -> todo.v1.CreateTodoResponse
	4,  // 14: todo.v1.TodoService.GetTodo:output_type -> todo.v1.GetTodoResponse
	6,  // 15: todo.v1.TodoService.ListTodos:output_type -> todo.v1.ListTodosResponse
	8,  // 16: todo.v1.TodoService.UpdateTodo:output_type -> todo.v1.UpdateTodoResponse
	12, // 17: todo.v1.TodoService.DeleteTodo:output_type -> google.protobuf.Empty
